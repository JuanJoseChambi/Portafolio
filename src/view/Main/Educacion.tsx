    ...
    <section className="min-h-80 bg-redd-500 pb-16  max-md:py-16" ref={refEducacion}>
        <section className="area h-auto bg-bluee-500 flex flex-col justify-center items-center scrollFadeBottom" ref={refScrollEducacion}> 
            ...
            <ul className="bg-gren-500 min-w-[60%] min-h-60 mx-auto flex flex-col medium:flex-row justify-center items-start space-y-5 medium:space-y-0 bg-redd-500">
              ...
              <TimeLine title="Autodidacta" date="24 Sep / 2022 - Actualidad" description="Me formé de manera autodidacta a través de cursos en YouTube, documentación y otras plataformas, explorando nuevas tecnologías y métodos de desarrollo. Siempre busco mejorar y formarme con los mejores estándares. Persigo un conocimiento Full-stack con las tecnologías que manejo actualmente."/>
            </ul>
        </section>
    </section>
  )
