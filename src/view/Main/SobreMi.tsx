...
function SobreMi() {
  ...
  return (
    <section className="area min-h-xl flex flex-wrap justify-around items-center space-y-28 py-10 medium:space-y-0 medium:py-0 bg-redd-500 ">
          ...
          <article className="w-[90%] medium:w-1/2 flex flex-col space-y-7 bg-bluee-500">
            ...
            <p className="text-sm font-light text-neutral-700">Soy Juan José, desarrollador Fullstack Jr. Inicialmente interesado en ciberseguridad y videojuegos en 2022, me adentré en el desarrollo web. Comenzando de una manera Autodidacta y graduado de bootcamps como SoyHenry, donde he fortalecido habilidades tecnicas como blandas.</p>
            
            <p className="text-sm font-light text-neutral-700">Mi enfoque se basa en la práctica constante y la adquisición continua de habilidades para ofrecer soluciones innovadoras. Con experiencia en frontend, backend y bases de datos, domino tecnologías clave como React, Express y PostgreSQL/MongoDB.</p>
