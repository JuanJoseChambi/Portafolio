    ...
    <main className="min-h-xl flex justify-center items-center">
        <section className="area flex justify-around items-center bg-redd-500 ">
          ...
          <picture className="w-96 relative flex justify-center items-center ">
            <div className={`absolute w-full h-full rounded-full transition-all duration-500 ${image ? "bg-white" : "bg-neutral-700 shadow-[0px_0px_10px_5px_#404040]"} `}></div>
            <img src={sombra} alt="" className={`rounded-full z-10 hover:scale-125 hover:drop-shadow-[10px_20px_10px_black] transition-all duration-500 `} onMouseEnter={MouseEnter} onMouseLeave={MouseLeave}/>
          </picture>
