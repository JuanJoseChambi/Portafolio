...
function TimeLine() {
  return (
    <ul className="bg-redd-500 min-w-[60%] h-60 mx-auto flex justify-center items-center">
        <li className='bg-blue-500 max-w-[400px] h-full flex flex-1 flex-col justify-start items-start space-y-1'>
