...
function CardsProyects({proyect, }:CardsProyectsProp) {
    ...
    // text-[#b1b1b1]    
  return (
    <section className="w-full min-h-60 flex justify-center items-center sm:justify-start sm:items-start flex-col sm:flex-row gap-y-1 sm:gap-x-0 bg-greend-200">
        ...
        <section className="area sm:w-[70%] h-full flex justify-between items-center flex-col gap-y-1 bg-redd-500">
            <div className="w-full relative py-2 flex justify-start items-center">
                ...
                <h3 style={{fontSize:"clamp(25px, 8vw, 50px)"}} className="font-bold text-5xl tracking-widest absolute text-neutral-800">{proyect.titulo.toUpperCase()}</h3>
            </div>
            ...
            <div className="w-full flex justify-between items-center flex-col md:flex-row gap-y-2 bg-blued-500">
                <div className="min-w-[350px] flex justify-center sm:justify-start items-center flex-wrap gap-x-4 bg-greend-500">
                ...
                <ul className="min-w-[50px] flex justify-center sm:justify-end items-center space-x-5 bg-redd-500">
                    {proyect.web && 
